...
import { IStudentInfoService } from "../Services/interfaces/studentInfo.service.interface.ts";
import { IStudentHomeworkService } from "../Services/interfaces/studentHomework.service.interface.ts";
import { IStudentQuizService } from "../Services/interfaces/studentQuiz.service.interface.ts";
import { IStudentSessionService } from "../Services/interfaces/studentSession.service.interface.ts";
import { IStudentParentService } from "../Services/interfaces/studentParent.service.interface.ts";
import { createStudentParentDTO } from "../dtos/studentParent.dto.ts";
import StudentInfoService from "../Services/studentInfoService.ts";
import StudentHomeworkService from "../Services/studentHomeworkService.ts";
import StudentQuizService from "../Services/studentQuizService.ts";
import StudentSessionService from "../Services/studentSessionService.ts";
import StudentParentService from "../Services/studentParentService.ts";
